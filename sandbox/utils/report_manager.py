...
class ReportMgrBase(object):
    ...
    def report_training(self, epoch, batch, num_batches,
                        learning_rate, report_stats):
        """
        ...
        return sandbox.utils.statistics.Statistics()
...
class ReportMgr(ReportMgrBase):
    ...
    def _report_training(self, epoch, batch, num_batches,
                         learning_rate, report_stats):
        """
        ...
        #                            learning_rate,
        #                            self.progress_step)
        report_stats = sandbox.utils.statistics.Statistics()
