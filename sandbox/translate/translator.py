...
import sandbox.translate.beam
import sandbox.input as inputters
import sandbox.utils.opts as opts
...
def build_translator(opt, report_score=True, logger=None, out_file=None):
    ...
    fields, model, model_opt = \
        sandbox.model_builder.load_test_model(opt, dummy_opt.__dict__)

    scorer = sandbox.translate.GNMTGlobalScorer(opt.alpha,
                                             opt.beta,
...
class Translator(object):
    ...
    Args:
       model (:obj:`sandbox.network.NMTModel`):
    ...
    def translate(self,
        ...
        builder = sandbox.translate.TranslationBuilder(
            data, self.fields,
    ...
    def _translate_batch(self, batch, data):
        ...
        beam = [sandbox.translate.Beam(beam_size, n_best=self.n_best,
                                    cuda=self.cuda,
