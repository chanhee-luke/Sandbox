...
class RNNDecoderBase(nn.Module):
    ...
    def __init__(self, rnn_type, # bidirectional_encoder, 
                 num_layers,
        ...
        #     self.context_gate = sandbox.modules.context_gate_factory(
        ...
        self.attn = sandbox.modules.GlobalAttention(
        ...
        if copy_attn and not reuse_copy_attn:
            self.copy_attn = sandbox.modules.GlobalAttention(
...
class StdRNNDecoder(RNNDecoderBase):
    ...
    def _build_rnn(self, rnn_type, **kwargs):
        rnn, _ = getattr(nn, rnn_type)(**kwargs)
        return rnn
...
class InputFeedRNNDecoder(RNNDecoderBase):
    ...
    def _build_rnn(self, rnn_type, input_size,
        ...
        if rnn_type == "LSTM":
            stacked_cell = sandbox.modules.stacked_rnn.StackedLSTM
        else:
            stacked_cell = sandbox.modules.stacked_rnn.StackedGRU
