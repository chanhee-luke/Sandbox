...
from sandbox.network.encoder import RNNEncoder, RNNLayer, vanillaRNNEncoder

from sandbox.network.decoder import InputFeedRNNDecoder, StdRNNDecoder

import sandbox.network

from sandbox.modules import Embeddings
from sandbox.utils.misc import use_gpu
...
def build_decoder(opt, embeddings):
    ...
    if opt.input_feed:
        ...
        return StdRNNDecoder(opt.rnn_type, 
                             # opt.brnn,
                             opt.dec_layers, opt.rnn_size,
                             opt.global_attention,
                             opt.coverage_attn,
...
def build_base_model(model_opt, fields, gpu, checkpoint=None):
    ...
    model = sandbox.network.NMTModel(encoder, decoder)
